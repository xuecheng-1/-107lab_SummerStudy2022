...
//        文本是bytebyte byte。。。的数据序列 ，文本文件是文本（char）序列按照某种编码方案（utf-8，utf-16，该板块）序列化为byte的存储
...
//       （2）序列化流（ObjectOutputStream),是过滤流--writeObject 反序列流（ObjectInputStream）--readObject
